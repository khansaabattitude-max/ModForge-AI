...
import { generateMod, moderateReview } from './services/geminiService';
        ...
        <div>
          ...
          <p className="text-sm text-red-400">
            ...
            <ul className="list-disc list-inside mt-1 space-y-1">
              ...
              <li>If the issue persists, check your API key and network connection.</li>
            </ul>
          </p>
        </div>
      </div>
    ...
    return (
      <div className="bg-mc-gray/50 border border-mc-light-gray rounded-lg p-6 w-full">
        ...
        <div>
          ...
          {activeTab === 'code' && (
            <div>
              <CodeBlock fileName="behavior_pack/scripts/main.js" code={modData.scripts.main} language="javascript" />
